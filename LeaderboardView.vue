...
/* --- RANK COLORING SCHEME --- */
.leaderboard-table tr.rank-1 { background-color: #3498db20; } /* Light Blue */
.leaderboard-table tr.rank-1 .rank-cell, .leaderboard-table tr.rank-1 .accuracy-cell {
    color: #3498db; /* Blue */
}

.leaderboard-table tr.rank-2 { background-color: #2ecc7120; } /* Light Green */
.leaderboard-table tr.rank-2 .rank-cell, .leaderboard-table tr.rank-2 .accuracy-cell {
    color: #2ecc71; /* Green */
}

.leaderboard-table tr.rank-3 { background-color: #e74c3c20; } /* Light Red/Orange */
.leaderboard-table tr.rank-3 .rank-cell, .leaderboard-table tr.rank-3 .accuracy-cell {
    color: #e74c3c; /* Red */
}

.leaderboard-table tr.rank-4 { background-color: #9b59b620; }
.leaderboard-table tr.rank-4 .rank-cell, .leaderboard-table tr.rank-4 .accuracy-cell {
    color: #9b59b6;
}

.leaderboard-table tr.rank-5 { background-color: #f1c40f20; }
