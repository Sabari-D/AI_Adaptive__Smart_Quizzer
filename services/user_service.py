...
#         # CRITICAL FIX: Ensure all fields are initialized correctly
#         user_data = {
#             "email": email,
#             "password": hashed_password,
#             "subjects_of_interest": [], # <-- Retained correct field name
#             "difficulty_level": "Beginner",
#             "performance_history": [], # <-- CRITICAL: Added back the missing field for consistency
#             "created_at": datetime.now()
#         }
...
class UserService:
    ...
    # 🛑 CRITICAL FIX: Updated signature to accept 4 required arguments 🛑
    def register_user(self, email, password, username, mobile_number):
        """
        Hashes the password and creates a new user document, including username and mobile number.
        Returns the email if registration is successful, None otherwise.
        """
        ...
        user_data = {
            ...
            "login_streak": 0,           # Initialize gamification streak
            "badges": [],                # Initialize badge array
            "created_at": datetime.now()
        }
