...
/* Style all input types (text, url, textarea, file) to ensure contrast */
input[type="text"], 
input[type="url"],
textarea, 
select, 
...
.method-options button.active {
    /* Hardcoded for selected state visual consistency (Purple/Accent) */
    background-color: #9b59b6; 
    border-color: #8e44ad;
    color: #fff;
    font-weight: bold;
...
button[type="submit"] {
    ...
    padding: 14px; 
    background-color: #2ecc71; 
    color: #1a1a2e; /* Fixed dark text for high contrast on green */
    border: none;
    border-radius: 12px;
    cursor: pointer;
    font-size: 1.2rem;
...
button[type="submit"]:disabled {
    background-color: #95a5a6; /* Standard gray for disabled */
