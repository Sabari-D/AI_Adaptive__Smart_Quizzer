...
.start-quiz-btn, .view-analytics-btn {
    width: 100%;
    padding: 14px; 
    background-color: #3498db; /* Specific color for button */
    color: white;
    border: none;
    border-radius: 12px;
    cursor: pointer;
...
.gauge-section {
    ...
    padding-bottom: 20px;
    margin-bottom: 30px;
    border-bottom: 1px dashed var(--color-border); /* Use theme variable */
    gap: 20px;
}
...
.doughnut-chart {
    ...
    height: 100%;
    border-radius: 50%;
    /* Use background color for the 'donut hole' background */
...
.chart-center {
    ...
    width: 90px;
    height: 90px;
    background: var(--color-card-bg); /* Use card background color */
    border-radius: 50%;
    display: flex;
    flex-direction: column;
    align-items: center;
...
.bar-track {
    background-color: var(--color-border); /* Use border color as track background */
    height: 25px;
    border-radius: 5px;
    overflow: hidden;
}
...
.bar-fill {
    ...
    line-height: 25px;
    padding-left: 10px;
    color: #1a1a2e; /* Always dark text on bar fill for high contrast */
    font-weight: bold;
    border-radius: 5px 0 0 5px;
    transition: width 1s ease-out; 
    text-align: left;
